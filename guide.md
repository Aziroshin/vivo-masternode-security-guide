...
2. To create *vivo-daemon*, the command will be this: *sudo adduser --shell=/bin/false --gecos "" --disabled-login vivo-daemon*
3. As we intend to log in as *user*, we will run the command *passwd user* in order to set a password. 
